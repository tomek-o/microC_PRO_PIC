...
Without a license key it runs in demo mode.
...
2K program words is exactly what parts like PIC16F684 have, it is not limiting chips like it at all. On the other hand, I've tried to use SDCC with PIC16Fxx (pic14 family in SDCC due to 14-bit code word size) in 2026 and I gave up because it generated code basically two times larger than microC. Big part of it is lack of PAGESEL tracking and for a part with 2K program words this is a major problem. Both pic14 and pic16 targets are at the moment not maintained in SDCC, but it looks like PIC18Fxx ("pic16" in SDCC) code generation is actually better optimized in SDCC while the pic14 would need this more.